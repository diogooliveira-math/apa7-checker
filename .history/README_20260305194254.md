...
> **Warning:** This is a personal-use tool, vibe coded during an internship. It was built to scratch a specific itch and is not production-grade software. Use at your own risk. Contributions welcome, but don't expect enterprise-level support. It was a result of vibe coding sessions as described in [this article](https://medium.com/@fdiogolparacasa/how-to-leverage-ai-agents-to-be-more-efficient-in-solving-problems-as-a-non-coder-7528b0cd8c89?postPublishedType=repub). This artifacts were latter on curated and shared in this repository for anyone who finds it useful. Always verify your references against the official APA 7 Publication Manual.
